...
\begin{tablist}
    ...
    \item[2020] \tab  Noyman, A., \& Larson, K.
    ...
    \item[2019] \tab  Doorley, R., Noyman, A., Sakai, Y., \& Larson, K.
    What’s your MoCho? Real-time Mode Choice Prediction Using Discrete Choice Models and a HCI Platform
    In KDD 2019 UrbComp.

    \item[2019] \tab  Doorley, R. and Noyman, A., Xiong, Z., Alonso, L., Grignard, A., \& Larson, K.
    ...
    \item[2019] \tab  Noyman, A., Doorley, R., Xiong, L., Grignard, A., \& Larson, K.
    ...
    \item[2018] \tab  Grignard, A., Macia, N., Alonso Pastor, L., Noyman, A., Zhang, Y., \& Larson, K.
    ...
    \item[2018] \tab  Alonso, L., Zhang, Y., Grignard, A., Noyman, A., Sakai, Y., ElKatsha, M., Doorley, R., \& Larson, K.
    ...
    \item[2018] \tab  Noyman, A., Sakai, Y., \& Larson, K.
    ...
    \item[2017] \tab  Ariel Noyman, et al
    ...
    \item[2017] \tab  Noyman, A., Stibe, A., \& Larson, K.
    ...
    \item[2016] \tab  Noyman, A., Stibe, A., \& Larson, K.
    ...
    \item[2015] \tab  Alrashed, T., Almalki, A., Aldawood, S., Alhindi, T., Winder, I., Noyman, A., Alfaris, A., \& Alwabil, A.
...
\begin{tablist}
    \item[2021] \tab HafenCity University Hamburg [HCU] and the foundation ZEIT-Stiftung Ebelin und Gerd Bucerius, \textit{Perspectives in Metropolitan Research}
    \href{https://www.jovis.de/en/books/series/perspectives-in-metropolitan-research.html}{JOVIS}

    \item[2021] \tab Raphel Schwegmann / Gesa Ziemer / Jörg Rainer Noennig (Hg.), \textit{Digital City Science. Researching New Technologies in Urban Environments}
    ...
    \item[2020] \tab Hubert Beroche, \textit{Urban AI}
    \href{https://urban-ai.co/wp-content/uploads/2020/06/URBAN-AI-1.pdf}{https://urban-ai.co}

    \item[2018] \tab Rafi Segal, \textit{Space Packed: The Architecture of Alfred Neumann}
    \href{https://www.amazon.com/Space-Packed-Architecture-Alfred-Neumann/dp/3038600555}{ISBN 9783038600558, 3038600555}


    \item[2018] \tab José Pinto Duarte, \textit{Mass Customization and Design Democratization},
    \href{https://www.google.com/books/edition/_/Z6h8DwAAQBAJ?hl=en&gbpv=0}{ISBN 9781351117845}


    \item[2015] \tab MIT CAU + ZUS + URBANISTEN with Deltares, 75B, and Volker Infra Design, \textit{New Meadowlands: Productive city + Regional park}
    \href{http://www.rebuildbydesign.org/our-work/all-proposals/winning-projects/nj-meadowlands}{http://www.rebuildbydesign.org/}

    \item[2010] \tab \textit{What Can We Learn from China? City/state Unit Moving Cities},
