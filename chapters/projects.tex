...
\begin{tablist}
   ...
   \begin{tablist}
      \item[`15-`23] \tab  {Lead the MIT/HCU CityScience Lab in Hamburg, Germany - a multi-year cooperation agreement between MIT and the Free and Hanseatic City of Hamburg, Germany, and HafenCity Universität Hamburg. Helped grow the lab from 0-35}
   \end{tablist}
