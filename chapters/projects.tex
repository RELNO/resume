...
\begin{tablist}
   ...
   \item[`15-present] \tab \textbf{City Science Network:} {Co-founded a network of City Science Labs around the world, including Andorra, Helsinki, Guadalajara, Shanghai, Detroit, Guadalajara, Ho Chi Minh City, Israel}
      ...
      \begin{tablist}
      \item[`22-present] \tab  {Co-founded and lead the \textbf{Negev Urban Research (NUR)}, an MIT/Israeli Gov. urban science lab in the Negev region. Initiated the lab, team, research, secured Gov. seed round of +\$2M}
   \end{tablist}

   \begin{tablist}
      \item[`15-`23] \tab  {Co-founded and lead the \textbf{HCU CityScience Lab} in Hamburg, Germany - a multi-year cooperation agreement between MIT and the Free and Hanseatic City of Hamburg, Germany, and HafenCity Universität Hamburg. Helped grow the lab from 0-35, secure projects and +5M EUR in funding}
   \end{tablist}
