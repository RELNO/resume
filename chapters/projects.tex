...
\begin{tablist}
    ...
    \item[`14 --] \tab \textbf{MIT CityScope} {an urban modelling, simulation, and decision making platform developed at the MIT City Science Center and deployed around the world}
    ...
    \item[`24-`26] \tab \textbf{The Right to Shelter} {Spatial analysis and collaborative planning tools for the provisioning of bomb shelter access for marginalized communities using spatial data analysis and machine learning methods.}

    \begin{tablist}
        \item[`25] \tab \href{https://www.ynetnews.com/real-estate/article/s1zbwjtyxx}{``Innovative algorithm aims to protect Negev Bedouin villages from missile attacks''}
    \end{tablist}
